...
const autostatusStatusReplyText = process.env.STATUS_REPLY_TEXT || '✅ Status Viewed By Luka Md';
...
const botGurl = process.env.BOT_GURL || "https://github.com/Lukaboe2/LUKA-MD";
const botTimezone = process.env.BOT_TIMEZONE || "Africa/Nairobi";
const botBotname = process.env.BOTNAME || "LUKA-MD";
const botPackname = process.env.BOT_PACKNAME || "LUKA-MD";
const botMode = process.env.BOT_MODE || "public";
const botSessionName = process.env.BOT_SESSION_NAME || "luka-md";
